...
Current release: **0.20.10 — 2026-09-20**.
...
- **Custom icon color**: the plug-in properties dialog offers *Auto*
  (the default — ink is black or white by band-background luminance) or
